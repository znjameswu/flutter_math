...
Future<void> loadKaTeXFonts() async {
  ...
  final katexMainLoader = FontLoader('packages/flutter_math/KaTeX_Main')
  ...
  final katexMathLoader = FontLoader('packages/flutter_math/KaTeX_Math')
  ...
  final katexFrakturLoader = FontLoader('packages/flutter_math/KaTeX_Fraktur')
  ...
  final katexSize2Loader = FontLoader('packages/flutter_math/KaTeX_Size2')
    ..addFont(getFontData('lib/katex_fonts/fonts/KaTeX_Size2-Regular.ttf'));

  final katexSize3Loader = FontLoader('packages/flutter_math/KaTeX_Size3')
    ..addFont(getFontData('lib/katex_fonts/fonts/KaTeX_Size3-Regular.ttf'));

  final katexSize4Loader = FontLoader('packages/flutter_math/KaTeX_Size4')
