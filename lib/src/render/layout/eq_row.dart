...
class EquationRow extends MultiChildRenderObjectWidget {
  EquationRow({
    Key key,
    this.spacings,
  ...
  // final ValueNotifier<NodeRange> range; //TODO
  ...
  @override
  RenderEquationRow createRenderObject(BuildContext context) =>
      RenderEquationRow(
        spacings: spacings,
  ...
  void updateRenderObject(
      BuildContext context, covariant RenderEquationRow renderObject) {
    renderObject
      ..spacings = spacings
      ..textBaseline = textBaseline
      // ..baselineReferenceWidgetNum = baselineReferenceWidgetNum
...
class RenderEquationRow extends RenderBox
    with
  ...
  void performLayout() {
    ...
    var child = firstChild;
    var spacingIter = spacings.iterator;
    final relativeChildren = <RenderBox>[];
    // final relativeChildrenMainPos = <double>[];
    while (child != null) {
      final childParentData = child.parentData as CrossSizeParentData;
      ...
      if (childParentData.relativeCrossSize != null) {
        ...
        // relativeChildrenMainPos.add(allocatedSize);
      } else {
      ...
      if (child != null) {
        spacingIter.moveNext();
        allocatedSize += spacingIter.current;
      }
    }
    ...
    while (child != null) {
      ...
      if (child != null) {
        spacingIter.moveNext();
        childMainPosition += spacingIter.current;
      }
    }
  }
