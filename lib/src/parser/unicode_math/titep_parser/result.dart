...
abstract class Result<I, O> extends Context<I> {
  const Result(List<I> buffer, int position, TextDirection direction)
      : super(buffer, position, direction);
...
class Success<I, R> extends Result<I, R> {
  const Success(
      List<I> buffer, int position, this.value, TextDirection direction)
      : super(buffer, position, direction);
